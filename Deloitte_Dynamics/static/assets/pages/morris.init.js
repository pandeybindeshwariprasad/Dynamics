...
!function($) {
    ...
    MorrisCharts.prototype.init = function() {
        ...
        this.createLineChart('morris-line-example', $data, 'y', ['a', 'b','c'], ['Series A', 'Series B', 'Series C'],['0.1'],['#ffffff'],['#999999'], ['#36404a', '#86BC25', '#5d9cec']);
        ...
        this.createAreaChart('morris-area-example', 0, 0, $areaData, 'y', ['a', 'b','c'], ['Series A', 'Series B','Series C'], ['#86BC25', '#5d9cec', '#bbbbbb']);
        ...
        this.createBarChart('morris-bar-example', $barData, 'y', ['a', 'b', 'c'], ['Series A', 'Series B', 'Series C'], ['#86BC25', '#5d9cec', '#ebeff2']);
        ...
        this.createDonutChart('morris-donut-example', $donutData, ['#ebeff2', '#86BC25', '#5d9cec']);
    },
    //init
